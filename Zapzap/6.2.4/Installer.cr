class Target < ISM::Software
    ...
    def prepareInstallation
        ...
        pythonData = <<-CODE
        pathappend /usr/lib/python#{softwareMajorVersion("@ProgrammingLanguages-Main:Python")}.#{softwareMinorVersion("@ProgrammingLanguages-Main:Python")}/site-packages/zapzap-#{majorVersion}.#{minorVersion}-py#{softwareMajorVersion("@ProgrammingLanguages-Main:Python")}.#{softwareMinorVersion("@ProgrammingLanguages-Main:Python")}.egg PYTHONPATH
        CODE
